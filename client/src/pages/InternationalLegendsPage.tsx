...
interface VerifyResult {
  ...
  imported: boolean;
  reason?: "not_retired" | "wrong_nation" | "not_enough_caps";
}
        ...
        if (result.valid && result.footballer) {
          ...
          const msg =
            result.reason === "not_retired"
              ...
              : result.reason === "not_enough_caps"
                ? `${displayName} has only ${result.capsForCountry ?? 0} caps for ${currentRound.country}`
