...
import { FREE_GAME, GATED_GAMES, BANTER_GAMES, type Game } from "@/lib/games";
import heroFallback from "@/assets/hero.png";

const FEATURES = [
  {
    icon: Beer,
    title: "Built for the pub",
    body: "Play with your mates and see whose football memory really holds up — the names people pull out are half the fun.",
  },
  {
    icon: History,
    title: "Pure nostalgia",
    body: "Centred on the classic, mostly retired greats of roughly 1990–2010. If you grew up on this era, it hits different.",
  },
  {
    icon: Lightbulb,
    title: "Clever clues",
    body: "Club logos, positions, squad numbers and nationalities drip-feed just enough to jog the memory.",
  },
  {
    icon: Sparkles,
    title: "Always fresh",
    body: "New games and daily challenges land all the time, so there’s always another one to crack.",
  },
];
...
export function PublicHomePage() {
    ...
    return (
      ...
      >
        <div className="flex items-center justify-between mb-3">
          ...
          <span className="text-[10px] font-bold uppercase tracking-wide text-green-400 bg-green-400/10 px-2 py-1 rounded-full">
            Free
          </span>
        </div>
  ...
  return (
    <div className="min-h-dvh bg-[#0b0c1a] pitch-grid text-white font-ui overflow-x-clip selection:bg-green-400/30">
      {/* Nav */}
      <header
        className={`sticky top-0 z-50 transition-colors duration-300 ${scrolled ? "backdrop-blur-md bg-[#0b0c1a]/80 divide-soft-b" : "bg-transparent"}`}
      >
        <div className="max-w-6xl mx-auto flex items-center justify-between px-4 py-3">
          ...
          <nav className="flex items-center gap-1 sm:gap-2 text-sm">
            <Link
              ...
              className={`hidden sm:inline text-white/80 hover:text-white font-medium px-3 py-2 rounded-lg ${btnFocus()}`}
            >
              Play free
            </Link>
            {user ? (
              <>
                {user.is_admin && (
                  <Link
                    to="/admin"
                    className={`text-white/80 hover:text-white font-medium px-3 py-2 rounded-lg ${btnFocus()}`}
                  >
                    Admin
                  </Link>
                )}
                <div className="relative" ref={menuRef}>
                  ...
                  >
                    <User size={16} />
                    <span className="hidden md:inline max-w-44 truncate text-xs text-white/50">
                      {user.email}
                    </span>
                    <ChevronDown
                      size={14}
                  ...
                  {menuOpen && (
                    <div className="absolute right-0 mt-2 w-44 bg-[#0b0c1a]/80 backdrop-blur-xl border border-white/5 rounded-xl overflow-hidden shadow-xl py-1 z-50">
                      <button
              ...
              <>
                ...
                <Link
                  to="/signup"
                  className={`bg-green-500 hover:bg-green-400 text-[#0b1020] font-bold rounded-lg px-4 py-2 uppercase tracking-wide text-xs transition-colors ${btnFocus()}`}
                >
                  Sign up
                </Link>
              </>
        ...
        <div className="relative max-w-6xl mx-auto px-4 pt-12 sm:pt-16 pb-16 grid md:grid-cols-2 gap-10 lg:gap-6 items-center">
          <div className="animate-rise text-center md:text-left">
            <span className="hidden sm:inline-flex items-center gap-1.5 text-green-400 text-xs font-bold uppercase tracking-[0.18em] mb-5 glass rounded-full px-3 py-1.5">
              <Trophy size={14} /> Win a FOOTBALL shirt for completing every
              game
            </span>
            ...
            <p className="mt-5 text-white/70 text-lg max-w-md leading-relaxed mx-auto md:mx-0">
              Test your knowledge of football's golden era. Clues drip in — club
              badges, squad numbers, positions and flags — until the name
              clicks. Brilliant solo, even better down the pub with your mates.
            </p>
          ...
          <div className="relative flex justify-center">
            ...
            {/* floating clue chips */}
            <span
              className="absolute left-0 top-10 hidden sm:flex items-center gap-2.5 glass rounded-2xl px-4 py-2.5 text-base font-bold shadow-xl animate-float"
            ...
            >
              ...
              <MiniClubBadge
                club="Roma"
                wikipediaUrl="https://en.wikipedia.org/wiki/AS_Roma"
                size={24}
              />
            </span>
            <span
              className="absolute right-2 bottom-16 hidden sm:flex items-center gap-2.5 glass rounded-2xl px-4 py-2.5 text-base font-bold shadow-xl animate-float"
            ...
            >
              ...
              <MiniClubBadge
                club="Real Madrid"
                wikipediaUrl="https://en.wikipedia.org/wiki/Real_Madrid_CF"
                size={24}
              />
      ...
      <section
        id="games"
        className="max-w-6xl mx-auto px-4 pt-14 pb-6 scroll-mt-20"
      >
        <div className="flex items-end justify-between mb-7 flex-wrap gap-2">
          ...
          <p className="text-white/50 text-sm">
            Reel off legendary lists of players with your mates —{" "}
            <span className="text-green-400 font-semibold">FREE</span> to play
          </p>
        </div>
      ...
      <section className="max-w-6xl mx-auto px-4 pt-6 pb-14">
        <div className="flex items-end justify-between mb-7 flex-wrap gap-2">
          ...
          <p className="text-white/50 text-sm">
            Quick-fire games to settle debates with your mates.
          </p>
        </div>
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
        ...
        <>
          ...
          <section className="divide-soft-y">
            <div className="max-w-6xl mx-auto px-4 py-14">
              <h2 className="font-display text-3xl tracking-tight text-center">
                Why you'll love it
              </h2>
            ...
            <div className="relative overflow-hidden rounded-4xl bg-linear-to-r from-green-500 to-emerald-400 text-[#0b1020] p-8 sm:p-10 flex flex-col sm:flex-row items-center gap-6 text-center sm:text-left">
              ...
              <div className="flex-1 relative">
                ...
                <p className="font-medium mt-1.5 opacity-90">
                  Complete all 16 games and you're in with a chance — we give
                  away a classic football shirt to players who finish the lot.
                </p>
              </div>
              {!user && (
                <button
          ...
          <section className="max-w-6xl mx-auto px-4 pb-16">
            <h2 className="font-display text-3xl tracking-tight text-center mb-9">
              How it works
            </h2>
              ...
              {[
                {
                  n: 1,
                  t: "Pick a game",
                  d: "Every game is free to play — jump straight in, no signup required.",
                },
                {
                  n: 2,
                  t: "Read the clues",
                  d: "Badges, numbers, positions and flags point you towards the answer.",
                },
                {
                  n: 3,
                  t: "Name the players",
                  d: "Type your guesses, rack up your score, then challenge your mates.",
                },
              ].map((s) => (
                <div key={s.n} className="glass rounded-3xl p-6">
                  <div className="font-display w-10 h-10 rounded-full bg-green-500 text-[#0b1020] flex items-center justify-center mb-4 glow-ring">
                    {s.n}
                  </div>
          ...
          {!user && (
            <section className="relative max-w-3xl mx-auto px-4 pb-20 text-center">
              ...
              <p className="text-white/70 mt-3">
                Every game is free. Create an account to save your scores and
