...
import { Users, UserCog, Building2, Database, Gamepad2, LayoutGrid, Trophy, Shuffle, Menu, X, Medal, Globe, Flag, Star, ArrowLeftRight, Banknote, Home, ShieldCheck, Plane, Target, Waypoints, MapPin, Sun, Network, Bookmark, UserX, Award, Goal, Languages, ListChecks, Beer, Croissant, Gem, Coins, Fingerprint, type LucideIcon } from "lucide-react";
...
const nav: { to: string; label: string; icon: LucideIcon; end?: boolean }[] = [
  ...
  { to: "/admin/only-player", label: "Only Player", icon: Fingerprint },
  ...
  { to: "/admin/bundesliga", label: "Bundesliga", icon: Beer },
  { to: "/admin/ligue-1", label: "Ligue 1", icon: Croissant },
  ...
  { to: "/admin/uncapped-players", label: "Uncapped Players", icon: UserX },
  { to: "/admin/club-legends", label: "Club Legends", icon: Star },
  { to: "/admin/random-lists", label: "Random Lists", icon: ListChecks },
  { to: "/admin/club-marksman", label: "Club Marksman", icon: Target },
  { to: "/admin/international-legends", label: "International Legends", icon: Award },
  { to: "/admin/international-marksman", label: "International Marksman", icon: Goal },
  { to: "/admin/club-foreigners", label: "Club Foreigners", icon: Languages },
  { to: "/admin/transfers", label: "Transfers", icon: ArrowLeftRight },
  { to: "/admin/transfer-history", label: "Transfer History", icon: Banknote },
  { to: "/admin/record-signings", label: "Record Signings", icon: Gem },
  { to: "/admin/record-sales", label: "Record Sales", icon: Coins },
