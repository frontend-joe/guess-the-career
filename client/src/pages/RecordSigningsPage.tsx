...
import {
  getRecordSigningsRounds,
  type RecordSigningsRound,
  type RoundSigning,
...
const PROGRESS_KEY = "record_signings_schedule_progress";
...
function buildRounds(data: RecordSigningsRound[], saved: SavedProgress): RoundResult[] {
  return data.map((r) => {
  ...
  return (
    <div className="flex flex-col items-center px-4 py-8 gap-6">
      <div className="text-center">
        ...
        <p className="text-gray-500 text-sm mt-2">{totalGuessed} / {totalPlayers} signings</p>
      </div>
          ...
          return (
            <div key={i} className="flex items-center gap-3 bg-white rounded-xl px-3 py-2.5 border border-gray-100">
              <div className="flex-1 min-w-0">
                ...
                <p className="text-xs text-gray-500">{total} signings</p>
              </div>
