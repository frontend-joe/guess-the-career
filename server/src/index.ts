...
import { onlyPlayerRouter } from './routes/only-player.ts'
...
import { bundesligaRouter } from './routes/bundesliga.ts'
import { ligue1Router } from './routes/ligue-1.ts'
...
import { clubForeignersRouter } from './routes/club-foreigners.ts'
...
app.route('/api/only-player', onlyPlayerRouter)
app.route('/api/foreigners', foreignersRouter)
app.route('/api/serie-a', serieARouter)
app.route('/api/la-liga', laLigaRouter)
app.route('/api/bundesliga', bundesligaRouter)
app.route('/api/ligue-1', ligue1Router)
...
app.route('/api/club-foreigners', clubForeignersRouter)
